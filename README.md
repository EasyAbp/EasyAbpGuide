...
| [Abp.Captcha](https://github.com/EasyAbp/Abp.Captcha) | An Abp module to generate CAPTCHAs and provide verification for app users through the Abp.Notifications module. | ![Backlog](https://img.shields.io/badge/-Backlog-lightgrey?style=flat-square) |
| [Abp.Notifications](https://github.com/EasyAbp/Abp.Notifications) | An integrated user notification service Abp module, support email, SMS, PM, and more other providers. | ![Backlog](https://img.shields.io/badge/-Backlog-lightgrey?style=flat-square) |
